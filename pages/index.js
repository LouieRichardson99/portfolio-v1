      ...
      <main>
        ...
        <section className="max-w-3xl mx-auto mt-12 sm:mt-20 w-11/12">
          ...
          <div className="mt-4">
            ...
            <p className="mb-3">
              I spend the majority of my time learning to code and computer
              science in the hope of being able to get my foot in the door of
              the tech world!
            </p>
            <p className="mb-3">
              I am mostly focusing on the front-end aspect of a website using
              frameworks like Next.js to deploy web applications efficiently.
            </p>
            <p>
              I am on the look out for a junior front-end development position,
